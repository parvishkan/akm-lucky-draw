...
export const LuxuryMagneticCTA: React.FC<LandingPageProps> = ({ onStart }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-xs mx-auto px-4 pb-12 z-20"
    >
      <motion.button
        ref={buttonRef}
        ...
        whileTap={{ scale: 0.96 }}
        className="relative w-full group overflow-hidden rounded-full p-[2px] focus:outline-none transition-all duration-300"
      >
        ...
        <div className="relative flex items-center justify-center gap-3 px-8 py-4.5 rounded-full bg-gradient-to-r from-akm-purple-base via-akm-purple-light to-akm-purple-base text-akm-gold-light font-sans font-bold text-base sm:text-lg tracking-widest uppercase overflow-hidden">
          ...
          <Gift className="w-5 h-5 text-akm-gold-royal animate-bounce relative z-10" />
