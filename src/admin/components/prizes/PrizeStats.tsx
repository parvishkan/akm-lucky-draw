...
import { Gift, Layers, CheckSquare, Sparkles, AlertTriangle } from 'lucide-react';
...
export const PrizeStats: React.FC<PrizeStatsProps> = ({
  ...
  const cards = [
    { title: 'Total Prize Types', count: totalTypes, color: 'border-[#FFD700]/30', textColor: 'text-white', icon: Layers },
    { title: 'Total Gifts Pool', count: totalGifts, color: 'border-[#FFD700]/30', textColor: 'text-white', icon: Gift },
    { title: 'Distributed', count: distributed, color: 'border-[#FFD700]/40', textColor: 'text-[#FFD700]', icon: CheckSquare },
    { title: 'Remaining', count: remaining, color: 'border-emerald-500/40', textColor: 'text-emerald-400', icon: Sparkles },
    { title: 'Low Stock Alerts', count: lowStockCount, color: 'border-amber-500/40', textColor: 'text-amber-400', icon: AlertTriangle },
  ];
